...
-   [Selector lists](https://developer.mozilla.org/es-ES/docs/Web/CSS/Selector_list)
    (`,`)
-   [Universal](https://developer.mozilla.org/es-ES/docs/Web/CSS/Universal_selectors)
    (`*`)
-   [Type](https://developer.mozilla.org/es-ES/docs/Web/CSS/Type_selectors)
    (`<tagname>`)
-   [Descendant](https://developer.mozilla.org/es-ES/docs/Web/CSS/Descendant_combinator)
    (` `)
-   [Child](https://developer.mozilla.org/es-ES/docs/Web/CSS/Child_combinator)
    (`>`)
-   Parent (`<`)
-   [Adjacent sibling](https://developer.mozilla.org/es-ES/docs/Web/CSS/Adjacent_sibling_combinator)
    (`+`)
-   [General sibling](https://developer.mozilla.org/es-ES/docs/Web/CSS/General_sibling_combinator)
    (`~`)
-   [Attribute](https://developer.mozilla.org/es-ES/docs/Web/CSS/Attribute_selectors)
...
-   Pseudos:
    -   [`:not`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:not)
    -   [`:contains`](https://api.jquery.com/contains-selector)
    -   `:icontains` (case-insensitive version of `:contains`)
    -   [`:has`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:has)
    -   [`:root`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:root)
    -   [`:empty`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:empty)
    -   [`:parent`](https://api.jquery.com/parent-selector)
    -   [`:first-child`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:first-child),
        [`:last-child`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:last-child),
        [`:first-of-type`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:first-of-type),
        [`:last-of-type`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:last-of-type)
    -   [`:only-of-type`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:only-of-type),
        [`:only-child`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:only-child)
    -   [`:nth-child`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:nth-child),
        [`:nth-last-child`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:nth-last-child),
        [`:nth-of-type`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:nth-of-type),
        [`:nth-last-of-type`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:nth-last-of-type),
    -   [`:link`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:link),
        [`:any-link`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:any-link)
    -   [`:visited`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:visited),
        [`:hover`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:hover),
        [`:active`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:active)
    ...
    -   [`:selected`](https://api.jquery.com/selected-selector),
        [`:checked`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:checked)
    -   [`:enabled`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:enabled),
        [`:disabled`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:disabled)
    -   [`:required`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:required),
        [`:optional`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:optional)
    ...
    -   [`:is`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:is), plus its
        legacy alias `:matches`
    -   [`:scope`](https://developer.mozilla.org/es-ES/docs/Web/CSS/:scope)
