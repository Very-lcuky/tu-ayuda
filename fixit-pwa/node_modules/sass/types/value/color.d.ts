...
export class SassColor extends Value {
   ...
   *
   * [RGB color]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/rgb
   * [missing component]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   ...
   * treated as a [missing component].
   *
   * [HSL color]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/hsl
   * [missing component]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   * [breaking changes]: /documentation/breaking-changes/null-alpha
   *
   * @throws `Error` if `alpha` is set and isn't `null` or a number between `0`
   ...
   * treated as a [missing component].
   *
   * [HWB color]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/hwb
   * [missing component]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   * [breaking changes]: /documentation/breaking-changes/null-alpha
   *
   * @throws `Error` if `alpha` is set and isn't `null` or a number between `0`
   ...
   * component].
   *
   * [Lab]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/lab
   * [Oklab]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/oklab
   * [missing component]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   *
   * @throws `Error` if `alpha` is set and isn't `null` or a number between `0`
   * and `1`.
   ...
   * component].
   *
   * [LCH]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/lch
   * [Oklch]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/oklch
   * [missing component]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   *
   * @throws `Error` if `alpha` is set and isn't `null` or a number between `0`
   * and `1`.
   ...
   * component].
   *
   * [RGB color space]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/color#using_predefined_colorspaces_with_color
   * [missing component]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   *
   * @throws `Error` if `alpha` is set and isn't `null` or a number between `0`
   * and `1`.
   ...
   * component].
   *
   * [XYZ color space]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value/color#using_the_xyz_colorspace_with_color
   * [missing component]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   *
   * @throws `Error` if `alpha` is set and isn't `null` or a number between `0`
   * and `1`.
   ...
   *
   * [missing channels]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   */
   ...
   * channel].
   *
   * [missing channel]: https://developer.mozilla.org/es-ES/docs/Web/CSS/color_value#missing_color_components
   */
