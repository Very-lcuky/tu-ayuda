 ...
 * [CSS declarations](https://developer.mozilla.org/es-ES/docs/Web/CSS/Syntax#css_declarations)
 *
 * ```js
...
declare class Declaration_ extends Node {
   ...
   * [important](https://developer.mozilla.org/es-ES/docs/Web/CSS/important)
   * specifier.
   *
   * ```js
