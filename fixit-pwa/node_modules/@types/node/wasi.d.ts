...
declare module "wasi" {
    ...
    class WASI {
         ...
         *
         * `start()` requires that `instance` exports a [`WebAssembly.Memory`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Memory) named `memory`. If
         ...
         *
         * `initialize()` requires that `instance` exports a [`WebAssembly.Memory`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Memory) named `memory`.
         ...
         * [`WebAssembly.Memory`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Memory) named `memory` or user specify a
         * [`WebAssembly.Memory`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Memory) object in `options.memory`. If the `memory` is invalid
         ...
         * of a [`WebAssembly.Instance`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Instance).
         * @since v13.3.0, v12.16.0
         */
