...
declare module "tls" {
     ...
     *
     * Returns [Error](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/Error) object, populating it with `reason`, `host`, and `cert` on
     * failure. On success, returns [undefined](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Data_structures#Undefined_type).
     *
