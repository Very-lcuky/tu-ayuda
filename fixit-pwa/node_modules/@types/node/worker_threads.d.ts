...
declare module "worker_threads" {
     ...
     *
     * This implementation matches [browser `MessagePort`](https://developer.mozilla.org/es-ES/docs/Web/API/MessagePort) s.
     * @since v10.5.0
     */
    class MessagePort extends EventEmitter {
         ...
         * the [HTML structured clone algorithm](https://developer.mozilla.org/es-ES/docs/Web/API/Web_Workers_API/Structured_clone_algorithm).
         *
         ...
         * * `value` may contain [`WebAssembly.Module`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/WebAssembly/Module) instances.
         ...
         * ```
         *
         * `transferList` may be a list of [`ArrayBuffer`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer), `MessagePort`, and `FileHandle` objects.
         * After transferring, they are not usable on the sending side of the channel
         * anymore (even if they are not contained in `value`). Unlike with `child processes`, transferring handles such as network sockets is currently
         * not supported.
         *
         * If `value` contains [`SharedArrayBuffer`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/SharedArrayBuffer) instances, those are accessible
     ...
     *
     * Like [Web Workers](https://developer.mozilla.org/es-ES/docs/Web/API/Web_Workers_API) and the `node:cluster module`, two-way communication
     ...
     * inherits from its global `Object` class. Objects passed to the [`port.onmessage()`](https://developer.mozilla.org/es-ES/docs/Web/API/MessagePort/onmessage) listener are also created in the
     * target context
     * and inherit from its global `Object` class.
     *
     * However, the created `MessagePort` no longer inherits from [`EventTarget`](https://developer.mozilla.org/es-ES/docs/Web/API/EventTarget), and only
     * [`port.onmessage()`](https://developer.mozilla.org/es-ES/docs/Web/API/MessagePort/onmessage) can be used to receive
     * events using it.
     * @since v11.13.0
