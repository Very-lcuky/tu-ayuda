...
declare module "assert" {
    ...
    namespace assert {
         ...
         * using the [`==` operator](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Operators/Equality). `NaN` is specially handled
         ...
         *
         * Tests shallow, coercive inequality with the [`!=` operator](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Operators/Inequality). `NaN` is
         ...
         * determined by [`Object.is()`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/Object/is).
         *
         * ```js
         * import assert from 'node:assert/strict';
         *
         ...
         *
         * If specified, `error` can be a [`Class`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Classes),
         * [`RegExp`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Guide/Regular_Expressions), a validation function,
         ...
         * ```
         *
         * Validate error message using [`RegExp`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Guide/Regular_Expressions):
         *
         ...
         *
         * If specified, `error` can be a [`Class`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Classes),
         * [`RegExp`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Guide/Regular_Expressions), or a validation
