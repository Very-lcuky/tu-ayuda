...
declare module "fs/promises" {
    ...
    interface FileHandle {
         ...
         * \[0, [`Number.MAX_SAFE_INTEGER`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/Number/MAX_SAFE_INTEGER)\] range. If `start` is
         ...
         * \[0, [`Number.MAX_SAFE_INTEGER`](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/Number/MAX_SAFE_INTEGER)\] range. Modifying a file rather than
         ...
         * [Iterable](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Iteration_protocols#The_iterable_protocol) object.
        ...
        /**
         * Write an array of [ArrayBufferView](https://developer.mozilla.org/es-ES/docs/Web/API/ArrayBufferView) s to the file.
         *
        ...
        /**
         * Read from a file and write to an array of [ArrayBufferView](https://developer.mozilla.org/es-ES/docs/Web/API/ArrayBufferView) s
     ...
     * with an [Error](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/Error) object. The following example checks if the file`/etc/passwd` can be read and
