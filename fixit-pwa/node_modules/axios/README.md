...
- Make [XMLHttpRequests](https://developer.mozilla.org/es-ES/docs/Web/API/XMLHttpRequest) from the browser
- Make [http](http://nodejs.org/api/http.html) requests from node.js
- Supports the [Promise](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/Promise) API
...
When using `catch`, or passing a [rejection callback](https://developer.mozilla.org/es-ES/docs/Web/JavaScript/Reference/Global_Objects/Promise/then) as second parameter of `then`, the response will be available through the `error` object as explained in the [Handling Errors](#handling-errors) section.
...
In a browser, you can use the [`URLSearchParams`](https://developer.mozilla.org/es-ES/docs/Web/API/URLSearchParams) API as follows:
