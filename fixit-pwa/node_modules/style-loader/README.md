...
If you target an [iframe](https://developer.mozilla.org/es-ES/docs/Web/API/HTMLIFrameElement) make sure you have sufficient access rights, the styles will be injected into the content document head.

#### `Selector`

Allows to setup custom [query selector](https://developer.mozilla.org/es-ES/docs/Web/API/Document/querySelector) where styles inject into the DOM.
