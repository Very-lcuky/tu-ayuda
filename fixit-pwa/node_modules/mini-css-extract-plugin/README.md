...
If you target an [iframe](https://developer.mozilla.org/es-ES/docs/Web/API/HTMLIFrameElement), make sure that the parent document has sufficient access rights to reach into the frame document and append elements to it.

##### `string`

Allows to setup custom [query selector](https://developer.mozilla.org/es-ES/docs/Web/API/Document/querySelector).
