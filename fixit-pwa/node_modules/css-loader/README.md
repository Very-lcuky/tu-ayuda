...
Allows exporting styles as array with modules, string or [constructable stylesheet](https://developers.google.com/web/updates/2019/02/constructable-stylesheets) (i.e. [`CSSStyleSheet`](https://developer.mozilla.org/es-ES/docs/Web/API/CSSStyleSheet)).
...
The default export is a [constructable stylesheet](https://developers.google.com/web/updates/2019/02/constructable-stylesheets) (i.e. [`CSSStyleSheet`](https://developer.mozilla.org/es-ES/docs/Web/API/CSSStyleSheet)).

Useful for [custom elements](https://developer.mozilla.org/es-ES/docs/Web/Web_Components/Using_custom_elements) and shadow DOM.
